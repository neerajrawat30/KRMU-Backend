...
const server = http.createServer((req, res) => {
    // Handle routes and send responses
});
...
- Use the Node.js `http` module (no external frameworks like Express)
- The server must be stoppable via the exported function for testing
